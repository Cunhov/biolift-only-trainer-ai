...
- Marcar cada exercício com metadados:
  { "nome": "...", "musculo_principal": "...", "musculos_secundarios": [...], "equipamento": "...", "nivel_recomendado": "inic/inter/avanc", "prioridade_no_dia": "alta/media/baixa" }
 ...
 "dias":[
  {
   ...
   "aquecimento":["...","..."],
   "bloco_trabalho":[
     {"ordem":1,"nome":"Flexão aberta","musculo":"Peito","series":3,"reps":"8-12","tempo":"2-0-1","descanso_s":60,"observacao":"regressao: joelhos"}
     ...
   ],
   "finisher":["..."],
   "duracao_total": 40
...
Saída (JSON):
{
 "exercicios": {
   "Flexao aberta": {
     "substituicoes":["Flexao pike", "Mergulho no banco"],
     "progressao":"Dips / Flexao com carga",
...
**Objetivo:** Criar um plano visualmente limpo, elegante e direto ao ponto. EVITE TABELAS GRANDES e excesso de texto. O formato deve ser "Mobile First", usando blocos verticais.

**Tarefas:**
1. Validar consistência: nenhum exercício fora da Lista autorizada.
2. Gerar documento Markdown estruturado da seguinte forma:

# Título do Plano (Ex: Hipertrofia Iniciante)

**Resumo:** Duração: X min | Foco: Y | Equipamentos: Z
...
### Dia X: [Nome do Treino]
**Aquecimento:** [Lista rápida 1 linha]

(Para cada exercício, use EXATAMENTE este formato de bloco - NÃO USE TABELAS):

### 1. Nome do Exercício
* **Músculo:** Peito
* **Séries x Reps:** 3 x 12
* **Descanso:** 60s
* **Obs:** Manter postura ereta.

(Fim da lista de exercícios)

**Finisher:** [Lista rápida]

---

## Progressão & Dicas
* **Semana 1:** Foco na técnica.
* **Semana 2-4:** Aumentar carga ou reps.

**Substituições Rápidas:**
* **Exercício A:** Opção B ou C.

**Saída:**
- Apenas o Markdown final. Sem JSON, sem preâmbulos.
`,
